...
<body class="bg-gray-50 text-gray-900 font-sans antialiased flex h-screen overflow-hidden selection:bg-[#4A5D23] selection:text-white">
    ...
    <aside class="w-64 bg-white border-r border-gray-200 flex flex-col justify-between">
        <div>
            ...
            <!-- Link Manajemen Akun / Pengguna -->
<a href="{{ route('admin.users.index') }}" 
   class="flex items-center px-4 py-3 mt-1 rounded-xl text-sm transition {{ request()->routeIs('admin.users.*') ? 'bg-[#4A5D23]/10 text-[#4A5D23] font-semibold' : 'text-gray-500 hover:bg-gray-50 hover:text-[#4A5D23] font-medium' }}">
...
<a href="{{ route('admin.messages.index') }}" 
   class="flex items-center px-4 py-3 mt-1 rounded-xl text-sm transition {{ request()->routeIs('admin.messages.*') ? 'bg-[#4A5D23]/10 text-[#4A5D23] font-semibold' : 'text-gray-500 hover:bg-gray-50 hover:text-[#4A5D23] font-medium' }}">
...
<a href="{{ route('admin.settings.index') }}" 
   class="flex items-center px-4 py-3 mt-1 rounded-xl text-sm transition {{ request()->routeIs('admin.settings.*') ? 'bg-[#4A5D23]/10 text-[#4A5D23] font-semibold' : 'text-gray-500 hover:bg-gray-50 hover:text-[#4A5D23] font-medium' }}">
